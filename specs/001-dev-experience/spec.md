...
### User Story 2 - Example Module (Priority: P1)

As a developer, I want a simple example demonstrating japikey functionality within japikey_go so that I can understand the project structure and usage patterns.

**Why this priority**: Provides a minimal, working example that demonstrates basic module usage.

**Independent Test**: A developer can examine the example and understand the basic project layout and usage.

**Acceptance Scenarios**:

1. **Given** a developer examining the codebase, **When** they look at the example, **Then** they see a minimal example demonstrating how to use the japikey functionality
2. **Given** the example, **When** it's built and tested, **Then** it runs correctly and demonstrates basic module usage
...
- **FR-002**: System MUST include a example demonstrating japikey functionality that shows basic usage patterns
...
- **Example**: A minimal example demonstrating how to use the japikey functionality showing basic usage patterns
...
- **SC-003**: The example serves as a clear example that enables developers to understand project structure and usage within 15 minutes
